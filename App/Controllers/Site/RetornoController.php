...
class RetornoController extends BaseController {
    ...
    public function pagseguro(){
        ...
        // if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['notificationType']) == 'transaction') {    ## DEScomentar para usar no Ambiente de Produção
            ...
            // $notificationCode = 'DD2D7A6D02B002B09FCCC4415FB1B81993FD';  # Status: ? ()     ## COMENTAR esta linha para usar no Ambiente de Produção
            // $notificationCode = '8DDDB73C1F391F3968FDD4039F8036773B36';  # Status: ? ()     ## COMENTAR esta linha para usar no Ambiente de Produção
            $notificationCode = '64CB4E7AFC89FC894A6CC4070F9C9ECE03A0';  # Status: ? ()     ## COMENTAR esta linha para usar no Ambiente de Produção
